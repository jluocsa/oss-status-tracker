...
**Last refreshed:** 2026-08-29 20:02
...
| [#6054](https://github.com/microsoft/agent-framework/pull/6054) | microsoft/agent-framework | samples: add McpDocsResearch declarative workflow showcasing agent-level MCP pattern | MERGEABLE | BLOCKED | 1✅, 1 skipped | copilot-pull-request-reviewer:COMMENTED | 98d |
| [#6046](https://github.com/microsoft/agent-framework/pull/6046) | microsoft/agent-framework | .NET: docs(decisions): resolve duplicate ADR sequence numbers (0016, 0021, 0024) | MERGEABLE | BLOCKED | 1✅, 1 skipped | copilot-pull-request-reviewer:COMMENTED, jluocsa:COMMENTED | 99d |
| [#5907](https://github.com/microsoft/agent-framework/pull/5907) | microsoft/agent-framework | .NET: docs(aspire-devui): align README usage example with WithAgentService semantics | MERGEABLE | BLOCKED | 1✅, 1 skipped | copilot-pull-request-reviewer:COMMENTED | 104d |
| [#5908](https://github.com/microsoft/agent-framework/pull/5908) | microsoft/agent-framework | .NET: fix(aspire-devui): ship Microsoft.Agents.AI.DevUI as a transitive dependency | MERGEABLE | BLOCKED | 1✅, 1 skipped | copilot-pull-request-reviewer:COMMENTED | 104d |
